...
const COMPETENCIES = [
  ...
  'Multidisciplinary Coordination','Architecture / Structure / MEP Coordination',
  'Façade Coordination','Authority Submission Coordination',
  'Dubai Municipality','Dubai Civil Defence','DEWA',
